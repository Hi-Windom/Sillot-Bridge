...
export const setProxy = () => {
    ...
    session.closeAllConnections().then(() => {
        ...
        session.setProxy({ proxyRules: proxyURL }).then(() => console.log("network proxy [" + proxyURL + "]"));
    });
    /// #endif
};
export const onGetConfig = (isStart) => {
...
export const initWindow = () => {
    ...
    ipcRenderer.on(Constants.SIYUAN_SEND_WINDOWS, (e, ipcData) => {
