...
const loadThirdIcon = (iconURL, data) => {
...
export const loadAssets = (data) => {
    ...
    if (window.siyuan.config.appearance.modeOS && ((window.siyuan.config.appearance.mode === 1 && OSTheme === "light") ||
...
export const setMode = (modeElementValue) => {
    /// #if !MOBILE
...
const updateMobileTheme = (OSTheme) => {
