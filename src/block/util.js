...
export const cancelSB = (protyle, nodeElement) => {
    const doOperations = [];
    ...
    const sbElement = nodeElement.cloneNode();
...
export const genSBElement = (layout, id, attrHTML) => {
...
export const jumpToParentNext = (protyle, nodeElement) => {
...
export const insertEmptyBlock = (protyle, position, id) => {
...
export const genEmptyBlock = (zwsp = true, wbr = true, string) => {
    let html = "";
    if (zwsp) {
        html = Constants.ZWSP;
    }
...
export const genEmptyElement = (zwsp = true, wbr = true, id) => {
