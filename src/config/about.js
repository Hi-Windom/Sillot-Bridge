...
<div class="b3-label">
    ...
    bindEvent: () => {
        ...
        const tokenElement = about.element.querySelector("#token");
...
<div class="b3-dialog__action">
    ...
    <button class="b3-button b3-button--text">${window.siyuan.languages.confirm}</button>
        ...
        const networkServeElement = about.element.querySelector("#networkServe");
        ...
        const googleAnalyticsElement = about.element.querySelector("#googleAnalytics");
        ...
        const uploadErrLogElement = about.element.querySelector("#uploadErrLog");
        ...
        const downloadInstallPkgElement = about.element.querySelector("#downloadInstallPkg");
        ...
        /// #if !BROWSER
        const autoLaunchElement = about.element.querySelector("#autoLaunch");
        ...
        about.element.querySelector("#aboutConfirm").addEventListener("click", () => {
            const scheme = about.element.querySelector("#aboutScheme").value;
            const host = about.element.querySelector("#aboutHost").value;
            const port = about.element.querySelector("#aboutPort").value;
