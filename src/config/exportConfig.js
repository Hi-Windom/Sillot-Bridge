...
<div class="fn__flex b3-label config__item">
    ...
    bindEvent: () => {
        exportConfig.element.querySelector("#blockRefTextLeft").value = window.siyuan.config.export.blockRefTextLeft;
        exportConfig.element.querySelector("#blockRefTextRight").value = window.siyuan.config.export.blockRefTextRight;
        exportConfig.element.querySelector("#tagOpenMarker").value = window.siyuan.config.export.tagOpenMarker;
        exportConfig.element.querySelector("#tagCloseMarker").value = window.siyuan.config.export.tagCloseMarker;
        const pandocBinPathElement = exportConfig.element.querySelector("#pandocBinPath");
        const setexprt = (pandocBin) => {
            fetchPost("/api/setting/setExport", {
                paragraphBeginningSpace: exportConfig.element.querySelector("#paragraphBeginningSpace").checked,
                addTitle: exportConfig.element.querySelector("#addTitle").checked,
                addFooter: exportConfig.element.querySelector("#addFooter").checked,
                blockRefMode: parseInt(exportConfig.element.querySelector("#blockRefMode").value, 10),
                blockEmbedMode: parseInt(exportConfig.element.querySelector("#blockEmbedMode").value, 10),
                fileAnnotationRefMode: parseInt(exportConfig.element.querySelector("#fileAnnotationRefMode").value, 10),
                blockRefTextLeft: exportConfig.element.querySelector("#blockRefTextLeft").value,
                blockRefTextRight: exportConfig.element.querySelector("#blockRefTextRight").value,
                tagOpenMarker: exportConfig.element.querySelector("#tagOpenMarker").value,
                tagCloseMarker: exportConfig.element.querySelector("#tagCloseMarker").value,
        ...
        const pandocBinElement = exportConfig.element.querySelector("#pandocBin");
