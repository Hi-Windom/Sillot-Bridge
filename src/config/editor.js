...
<label class="b3-label fn__flex">
    ...
    bindEvent: () => {
        const fontFamilyElement = editor.element.querySelector("#fontFamily");
        ...
        const setEditor = () => {
            let dynamicLoadBlocks = parseInt(editor.element.querySelector("#dynamicLoadBlocks").value);
            if (48 > dynamicLoadBlocks) {
                dynamicLoadBlocks = 48;
                editor.element.querySelector("#dynamicLoadBlocks").value = "48";
            }
            if (1024 < dynamicLoadBlocks) {
                dynamicLoadBlocks = 1024;
                editor.element.querySelector("#dynamicLoadBlocks").value = "1024";
            }
            fetchPost("/api/setting/setEditor", {
                fullWidth: editor.element.querySelector("#fullWidth").checked,
                justify: editor.element.querySelector("#justify").checked,
                rtl: editor.element.querySelector("#rtl").checked,
                readOnly: editor.element.querySelector("#readOnly").checked,
                displayBookmarkIcon: editor.element.querySelector("#displayBookmarkIcon").checked,
                displayNetImgMark: editor.element.querySelector("#displayNetImgMark").checked,
                codeSyntaxHighlightLineNum: editor.element.querySelector("#codeSyntaxHighlightLineNum").checked,
                embedBlockBreadcrumb: editor.element.querySelector("#embedBlockBreadcrumb").checked,
                listLogicalOutdent: editor.element.querySelector("#listLogicalOutdent").checked,
                spellcheck: editor.element.querySelector("#spellcheck").checked,
                floatWindowMode: editor.element.querySelector("#floatWindowMode").checked ? 0 : 1,
                plantUMLServePath: editor.element.querySelector("#plantUMLServePath").value,
                katexMacros: editor.element.querySelector("#katexMacros").value,
                codeLineWrap: editor.element.querySelector("#codeLineWrap").checked,
                virtualBlockRef: editor.element.querySelector("#virtualBlockRef").checked,
                virtualBlockRefInclude: editor.element.querySelector("#virtualBlockRefInclude").value,
                virtualBlockRefExclude: editor.element.querySelector("#virtualBlockRefExclude").value,
                blockRefDynamicAnchorTextMaxLen: parseInt(editor.element.querySelector("#blockRefDynamicAnchorTextMaxLen").value),
                backlinkExpandCount: parseInt(editor.element.querySelector("#backlinkExpandCount").value),
                dynamicLoadBlocks: dynamicLoadBlocks,
                codeLigatures: editor.element.querySelector("#codeLigatures").checked,
                codeTabSpaces: parseInt(editor.element.querySelector("#codeTabSpaces").value),
                fontSize: parseInt(editor.element.querySelector("#fontSize").value),
                generateHistoryInterval: parseInt(editor.element.querySelector("#generateHistoryInterval").value),
                historyRetentionDays: parseInt(editor.element.querySelector("#historyRetentionDays").value),
