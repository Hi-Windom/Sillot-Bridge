...
export class Dock {
    ...
    constructor(options) {
        switch (options.position) {
            case "Left":
                this.layout = window.siyuan.layout.layout.children[0].children[0];
                ...
                break;
            case "Right":
                this.layout = window.siyuan.layout.layout.children[0].children[2];
                this.resizeElement = this.layout.element.previousElementSibling;
                this.layout.element.classList.add("layout__dockr");
                this.layout.element.insertAdjacentHTML("beforeend", "<div class=\"layout__dockresize layout__dockresize--lr\"></div>");
                break;
            case "Bottom":
                this.layout = window.siyuan.layout.layout.children[1];
                this.resizeElement = this.layout.element.previousElementSibling;
    ...
    <svg><use xlink:href="#iconPin"></use></svg>
        ...
        this.layout.element.querySelector(".layout__dockresize").addEventListener("mousedown", (event) => {
