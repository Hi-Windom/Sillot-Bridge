...
const getActionMenu = (element, next) => {
...
export const bindMenuKeydown = (event) => {
    ...
    if (event.code === "ArrowDown" || event.code === "ArrowUp") {
        ...
        if (!currentElement) {
            ...
            const textElement = currentElement.querySelector(".b3-text-field");
            const checkElement = currentElement.querySelector(".b3-switch");
            if (textElement) {
                textElement.focus();
                return true;
            }
