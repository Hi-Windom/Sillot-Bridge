...
import { bootSync, downloadProgress, processSync, progressBackgroundTask, progressLoading, progressStatus, setTitle, transactionError } from "./dialog/processSystem";
...
class App {
    constructor() {
        ...
        fetchPost("/api/system/getConf", {}, response => {
            ...
            const workspaceName = window.siyuan.config.system.workspaceDir.replaceAll("\\", "/").split("/").at(-1);
