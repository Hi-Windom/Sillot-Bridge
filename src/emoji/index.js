...
export const unicode2Emoji = (unicode, assic = false, className = "", needSpan = false, lazy = false) => {
    if (!unicode) {
        return "";
    }
    let emoji = "";
...
export const lazyLoadEmoji = (element, assic = false) => {
...
export const lazyLoadEmojiImg = (element) => {
    const emojiIntersectionObserver = new IntersectionObserver((entries) => {
        entries.forEach((entrie) => {
...
export const filterEmoji = (key = "", max, assic = false) => {
    let html = "";
    const recentEmojis = [];
    if (key) {
...
export const openEmojiPanel = (id, target, isNotebook = false) => {
...
export const updateOutlineEmoji = (unicode, id) => {
    /// #if !MOBILE
...
export const updateFileTreeEmoji = (unicode, id, icon = "iconFile") => {
    let emojiElement;
    /// #if MOBILE
