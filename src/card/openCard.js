...
export const openCardByData = (cardsData, html = "") => {
    ...
    dialog.element.querySelector(".b3-dialog__scrim").style.backgroundColor = "var(--b3-theme-background)";
    dialog.element.querySelector(".b3-dialog__container").style.maxWidth = "1024px";
    const editor = new Protyle(dialog.element.querySelector("[data-type='render']"), {
        blockId: "",
    ...
    dialog.element.firstElementChild.style.zIndex = "200";
    ...
    dialog.element.addEventListener("click", (event) => {
        ...
        if (!type) {
            const buttonElement = hasClosestByClassName(event.target, "b3-button");
            if (buttonElement) {
...
const allDone = (countElement, editor, actionElements) => {
