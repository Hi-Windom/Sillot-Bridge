...
export const viewCards = (deckID, title, deckType, cb) => {
    let pageIndex = 1;
    let edit;
    ...
    <div class="${isMobile() ? "fn__flex-column" : "fn__flex"} fn__flex-1" style="min-height: auto">
        ...
        edit = new Protyle(dialog.element.querySelector("#cardPreview"), {
            blockId: "",
            render: {
                gutter: true,
