...
export const hintSlash = (key, protyle) => {
    const allList = [{
...
export const hintTag = (key, protyle) => {
...
export const hintRef = (key, protyle, isQuick = false) => {
...
export const hintEmbed = (key, protyle) => {
...
export const hintRenderTemplate = (value, protyle, nodeElement) => {
...
export const hintRenderWidget = (value, protyle) => {
    focusByRange(protyle.toolbar.range);
...
export const hintRenderAssets = (value, protyle) => {
    focusByRange(protyle.toolbar.range);
...
export const hintMoveBlock = (pathString, sourceElements, protyle) => {
    if (pathString === "/") {
        return;
    }
