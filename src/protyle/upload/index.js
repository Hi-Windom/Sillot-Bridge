...
const validateFile = (protyle, files) => {
...
const genUploadedLabel = (responseText, protyle) => {
...
export const uploadLocalFiles = (files, protyle, isUpload) => {
...
export const uploadFiles = (protyle, files, element, successCB) => {
            ...
            if (xhr.status === 200) {
                ...
                if (protyle.options.upload.success) {
                    ...
                    if (protyle.options.upload.format) {
                        responseText = protyle.options.upload.format(files, xhr.responseText);
                    }
