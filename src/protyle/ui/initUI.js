...
export const addLoading = (protyle) => {
...
export const removeLoading = (protyle) => {
...
export const setPadding = (protyle) => {
    ...
    if (window.siyuan.config.editor.codeSyntaxHighlightLineNum) {
        setTimeout(() => {
            protyle.wysiwyg.element.querySelectorAll('.code-block [contenteditable="true"]').forEach((block) => {
