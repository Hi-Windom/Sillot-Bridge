...
import { getContenteditableElement, getLastBlock, getNextBlock, getPreviousBlock, getTopAloneElement, getTopEmptyElement, hasNextSibling } from "./getBlock";
...
const removeLi = (protyle, blockElement, range) => {
...
export const removeBlock = (protyle, blockElement, range) => {
    ...
    const previousLastElement = getLastBlock(previousElement);
