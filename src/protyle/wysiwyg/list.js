...
export const updateListOrder = (listElement, sIndex) => {
...
export const genListItemElement = (listItemElement, offset = 0, wbr = false) => {
...
export const listIndent = (protyle, liItemElements, range) => {
    const previousElement = liItemElements[0].previousElementSibling;
    if (!previousElement) {
        return;
    }
...
export const breakList = (protyle, blockElement, range) => {
...
export const listOutdent = (protyle, liItemElements, range) => {
