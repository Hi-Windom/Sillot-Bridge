...
let getIndexTimeout;
export const scrollEvent = (protyle, element) => {
    ...
    element.addEventListener("scroll", () => {
            ...
            getIndexTimeout = window.setTimeout(() => {
                ...
                if (!blockElement) {
                    if (hasClosestByClassName(targetElement, "protyle-background") ||
                        ...
                        const inputElement = protyle.scroll.element.querySelector(".b3-slider");
        ...
        if (protyle.wysiwyg.element.getAttribute("data-top") || protyle.block.showAll ||
            (protyle.scroll?.element.classList.contains("fn__none")) || !protyle.scroll ||
