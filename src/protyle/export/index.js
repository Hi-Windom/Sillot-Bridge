...
export const saveExport = (option) => {
    /// #if !BROWSER
    if (option.type === "pdf") {
...
<div class="b3-dialog__action">
    ...
    <button class="b3-button b3-button--text">${window.siyuan.languages.confirm}</button>
        ...
        btnsElement[1].addEventListener("click", () => {
            const removeAssets = wordDialog.element.querySelector("#removeAssets").checked;
            const mergeSubdocs = wordDialog.element.querySelector("#mergeSubdocs").checked;
...
const getExportPath = (option, removeAssets, mergeSubdocs) => {
...
const onExport = (data, filePath, type, removeAssets, msgId) => {
