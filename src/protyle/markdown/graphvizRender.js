...
export const graphvizRender = (element, cdn = Constants.PROTYLE_CDN) => {
    ...
    addScript(`${cdn}/js/graphviz/viz.js?v=0.0.0`, "protyleGraphVizScript").then(() => {
        graphvizElements.forEach((e) => {
            ...
            try {
                const blob = new Blob([`importScripts('${document.getElementById("protyleGraphVizScript").src.replace("viz.js", "full.render.js")}');`], { type: "application/javascript" });
