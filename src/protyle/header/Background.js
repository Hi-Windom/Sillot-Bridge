...
export class Background {
    ...
    iconElement;
    tagsElement;
    transparentData = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=";
    constructor(protyle) {
...
<div class="protyle-background__iconw">
    ...
    <div class="protyle-icons fn__flex-center">
        ...
        if (isMobile()) {
            this.imgElement.addEventListener("touchstart", (event) => {
