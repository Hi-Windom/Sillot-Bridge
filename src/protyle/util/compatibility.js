...
// Mac，Windows 快捷键展示
export const updateHotkeyTip = (hotkey) => {
...
export const hotKey2Electron = (key) => {
    let electronKey = "";
    if (key.indexOf("⌘") > -1) {
...
export const setStorageVal = (key, val) => {
