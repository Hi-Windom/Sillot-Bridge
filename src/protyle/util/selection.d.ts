...
export declare const focusByOffset: (container: Element, start: number, end: number) => any;
export declare const focusByWbr: (element: Element, range: Range) => void;
export declare const focusByRange: (range: Range) => void;
export declare const focusBlock: (element: Element, parentElement?: HTMLElement, toStart?: boolean) => any;
