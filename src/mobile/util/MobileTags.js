...
<img style="position: absolute;top: 0;left: 0;height: 100%;width: 100%;padding: 30vw;box-sizing: border-box;" src="/stage/loading-pure.svg">`;
        this.tree = new Tree({
            element: this.element.querySelector(".tagList"),
            data: null,
            click: (element) => {
                const actionElement = hasClosestByClassName(event.target, "b3-list-item__action");
                if (actionElement) {
...
<div class="b3-dialog__action">
    ...
    <button class="b3-button b3-button--text">${window.siyuan.languages.confirm}</button>
                    ...
                    document.getElementById("toolbarSearch").value = `#${element.getAttribute("data-label")}#`;
                    toolbarSearchEvent();
                }
            },
